...
<head>
    ...
    <title>Cargar Clientes desde Excel</title>
...
<body>
    ...
    <div class="main-content">
        <header class="header">
            <div class="header-left">
                <h1>📊 Carga Masiva Excel - Clientes</h1>
            </div>
            ...
            <div class="card">
                ...
                <div class="info-box">
                    ...
                    <ul>
                        ...
                        <li>Las columnas deben ser: <strong>TIPO DOC | DOCUMENTO | NOMBRE/RAZÓN SOCIAL | APELLIDO | EMAIL | TELÉFONO | CELULAR | DIRECCIÓN | DISTRITO | PROVINCIA | DEPARTAMENTO</strong></li>
                        <li>Descarga la plantilla para ver el formato correcto</li>
                        <li>Los documentos duplicados serán omitidos</li>
                        <li>DNI debe tener 8 dígitos, RUC debe tener 11 dígitos</li>
                    </ul>
                </div>
    ...
    <script>
        ...
        function mostrarPreview(data) {
            ...
            tableHTML += '<th>Tipo Doc</th><th>Documento</th><th>Nombre/Razón Social</th><th>Apellido</th><th>Email</th><th>Celular</th><th>Dirección</th><th>Distrito</th>';
            tableHTML += '</tr></thead><tbody>';

            data.preview.forEach(row => {
                tableHTML += '<tr>';
                tableHTML += `<td>${row.tipo_documento}</td>`;
                tableHTML += `<td>${row.documento}</td>`;
                tableHTML += `<td>${row.nombre_razon_social}</td>`;
                tableHTML += `<td>${row.apellido || '-'}</td>`;
                tableHTML += `<td>${row.email}</td>`;
                tableHTML += `<td>${row.celular}</td>`;
        ...
        document.getElementById('btnConfirmar').addEventListener('click', () => {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    window.location.href = 'index.php?success=' + encodeURIComponent('Clientes importados exitosamente');
                } else {
                    alert('Error: ' + data.mensaje);
                }
            })
